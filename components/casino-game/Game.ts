...
export const hintcontainer: PIXI.Container = new PIXI.Container();
const maincontainer: PIXI.Container = new PIXI.Container();
const topcontainer: PIXI.Container = new PIXI.Container();
/**
 * main renderer
 */
 ...
 */
export const UPDATE_BIG_BUTTONS: string = "UPDATE_BIG_BUTTONS";
/**
