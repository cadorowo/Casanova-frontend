		...
		return (
			<div className="modal-window-npass">
				<div className="modal-window-npass__scale-cont">
					...
					<input className="modal-window-npass__pass1 modal-window-npass__fields" type="text"  onInput={this.onInput} placeholder={defaultText1} />
					<input className="modal-window-npass__pass2 modal-window-npass__fields" type="text"  onInput={this.onInput} placeholder={defaultText2} />
