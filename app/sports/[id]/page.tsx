...
const MARKET_ORDER: Record<string, number> = {
  ...
  'Final Score': 60,
  'Correct Score': 60,
  'Result / Both Teams To Score': 65,
  'Half Time/Full Time': 68,
  'Asian Handicap': 70,
  '3-Way Handicap': 80,
  'Handicap Result': 80,
  '1x2 (1st Half)': 85,
  'Over/Under (1st Half)': 87,
  'Asian Handicap (1st Half)': 88,
  'Both Teams To Score (1st Half)': 89,
  'First Half Winner': 85,
  'To Win 2nd Half': 90,
  'Both Teams To Score (2nd Half)': 91,
  'Home Team Score a Goal (2nd Half)': 92,
  'Away Team Score a Goal (2nd Half)': 93,
  'Home Team Goals': 95,
  'Away Team Goals': 95,
  'Total - Home': 95,
  'Total - Away': 95,
...
const NOISY_LIVE_MARKET_PATTERNS = [
  ...
  /^asian corners$/i,
  /^match goals$/i,
  /^over\/under line \(1st half\)$/i,
  /how many goals will .+ team score/i,
  /european handicap \(1st half\)/i,
  /correct score \(1st half\)/i,
  /home team .+ to score in both halves/i,
  /which team will score the \d(nd|rd|th) goal/i,
  /^last team to score/i,
];
